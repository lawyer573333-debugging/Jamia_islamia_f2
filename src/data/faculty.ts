...
export const facultyData: FacultyMember[] = [
  {
    ...
    sourceNote: 'VERIFIED PHOTOGRAPH & PROFILE',
  },
  {
    id: 'lead_nazim',
    name: {
    ...
    biography: {
      ur: 'مولانا قاری عابد حسین بٹ صاحب جامعہ کے ناظمِ اعلیٰ کے طور پر انتظامی، تعلیمی اور تنظیمی امور کی نگرانی فرماتے ہیں۔',
      en: 'Maulana Qari Abid Hussain Butt oversees operational, academic, and administrative functions as Nazim-e-Aala of Jamia Tul Uloom Al-Islamia.',
    },
    qualifications: {
      ur: 'قاری و عالمِ دین',
      en: 'Qari & Islamic Scholar',
    },
    verified: true,
    status: 'verified',
    placeholderImage: {
      id: 'img_nazim',
      category: 'leadership',
      suggestedPath: 'public/leadership/nazim-e-aala.jpg',
