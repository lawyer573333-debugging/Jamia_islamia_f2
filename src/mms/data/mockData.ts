...
export const ROLE_NAVIGATION: Record<MmsRole, MmsNavItem[]> = {
  mudeer: [
    ...
    { id: 'mms_students', labelUrdu: 'طلباء', labelEnglish: 'Students', iconName: 'Users', badge: '840', badgeType: 'info' },
    { id: 'mms_teachers', labelUrdu: 'اساتذہ کرام', labelEnglish: 'Teachers', iconName: 'GraduationCap', badge: '42', badgeType: 'info' },
    { id: 'mms_classes', labelUrdu: 'کلاسز و درجات', labelEnglish: 'Classes', iconName: 'BookOpen' },
    { id: 'mms_attendance', labelUrdu: 'حاضری ریکارڈ', labelEnglish: 'Attendance', iconName: 'CalendarCheck2' },
    { id: 'mms_exams', labelUrdu: 'امتحانات و نتائج', labelEnglish: 'Exams & Results', iconName: 'Award' },
    { id: 'mms_fees', labelUrdu: 'فیس و واجبات', labelEnglish: 'Fees', iconName: 'CreditCard' },
    { id: 'mms_donations', labelUrdu: 'عطیات و زکوٰۃ', labelEnglish: 'Donations', iconName: 'HeartHandshake' },
    { id: 'mms_expenses', labelUrdu: 'جامعہ اخراجات', labelEnglish: 'Expenses', iconName: 'Receipt' },
    { id: 'mms_salaries', labelUrdu: 'تنخواہوں کا ریکارڈ', labelEnglish: 'Salaries', iconName: 'Wallet' },
    { id: 'mms_hostel', labelUrdu: 'دار الاقامہ (ہاسٹل)', labelEnglish: 'Hostel', iconName: 'Building2', badge: '89%', badgeType: 'warning' },
    { id: 'mms_kitchen', labelUrdu: 'مطعم و کچن', labelEnglish: 'Kitchen / Mess', iconName: 'Utensils' },
    { id: 'mms_inventory', labelUrdu: 'اسٹاک و انوینٹری', labelEnglish: 'Inventory', iconName: 'Package', badge: '4 کم', badgeType: 'warning' },
    { id: 'mms_purchases', labelUrdu: 'خریداری ریکارڈ', labelEnglish: 'Purchases', iconName: 'ShoppingCart' },
    { id: 'mms_reports', labelUrdu: 'جامع رپورٹس', labelEnglish: 'Reports', iconName: 'BarChart3' },
    { id: 'mms_announcements', labelUrdu: 'اعلانات و سرکلر', labelEnglish: 'Announcements', iconName: 'Bell' },
    { id: 'mms_settings', labelUrdu: 'سسٹم سیٹنگز', labelEnglish: 'Settings', iconName: 'Settings' },
  ],
  teacher: [
    { id: 'mms_teacher', labelUrdu: 'ڈیش بورڈ', labelEnglish: 'Dashboard', iconName: 'LayoutDashboard' },
    { id: 'mms_teacher_classes', labelUrdu: 'میری کلاسز', labelEnglish: 'My Classes', iconName: 'BookOpen', badge: '3', badgeType: 'info' },
    { id: 'mms_teacher_attendance', labelUrdu: 'طلباء کی حاضری', labelEnglish: 'Student Attendance', iconName: 'CalendarCheck2' },
    { id: 'mms_teacher_exams', labelUrdu: 'امتحانات و نتائج', labelEnglish: 'Exams & Results', iconName: 'Award' },
    { id: 'mms_teacher_lessons', labelUrdu: 'روزانہ کے اسباق', labelEnglish: 'Lessons', iconName: 'FileSpreadsheet' },
    { id: 'mms_teacher_hifz', labelUrdu: 'حفظِ قرآن پیش رفت', labelEnglish: 'Hifz Progress', iconName: 'BookmarkCheck' },
    { id: 'mms_teacher_my_attendance', labelUrdu: 'میری حاضری', labelEnglish: 'My Attendance', iconName: 'UserCheck' },
    { id: 'mms_teacher_leave', labelUrdu: 'رخصت کی درخواست', labelEnglish: 'Leave', iconName: 'Clock' },
    { id: 'mms_teacher_announcements', labelUrdu: 'اعلانات', labelEnglish: 'Announcements', iconName: 'Bell' },
    { id: 'mms_teacher_profile', labelUrdu: 'میرا پروفائل', labelEnglish: 'Profile', iconName: 'User' },
  ],
  counter: [
    { id: 'mms_counter', labelUrdu: 'ڈیش بورڈ', labelEnglish: 'Dashboard', iconName: 'LayoutDashboard' },
    { id: 'mms_counter_fees', labelUrdu: 'فیس وصولی', labelEnglish: 'Fee Collection', iconName: 'CreditCard' },
    { id: 'mms_counter_donations', labelUrdu: 'عطیات', labelEnglish: 'Donations', iconName: 'HandCoins' },
    { id: 'mms_counter_zakat', labelUrdu: 'زکوٰۃ فنڈ', labelEnglish: 'Zakat', iconName: 'Coins' },
    { id: 'mms_counter_sadaqah', labelUrdu: 'صدقات', labelEnglish: 'Sadaqah', iconName: 'Heart' },
    { id: 'mms_counter_receipts', labelUrdu: 'رسیدات جاریہ', labelEnglish: 'Receipts', iconName: 'Receipt', badge: '19 آج', badgeType: 'info' },
    { id: 'mms_counter_daily', labelUrdu: 'یومیہ وصولی سمری', labelEnglish: 'Daily Collection', iconName: 'FileCheck2' },
    { id: 'mms_counter_announcements', labelUrdu: 'اعلانات', labelEnglish: 'Announcements', iconName: 'Bell' },
    { id: 'mms_counter_profile', labelUrdu: 'پروفائل', labelEnglish: 'Profile', iconName: 'User' },
  ],
  parent: [
    { id: 'mms_parent', labelUrdu: 'ڈیش بورڈ', labelEnglish: 'Dashboard', iconName: 'LayoutDashboard' },
    { id: 'mms_parent_children', labelUrdu: 'میرے بچے', labelEnglish: 'My Children', iconName: 'Users', badge: '2', badgeType: 'info' },
    { id: 'mms_parent_attendance', labelUrdu: 'حاضری ریکارڈ', labelEnglish: 'Attendance', iconName: 'CalendarCheck2' },
    { id: 'mms_parent_lessons', labelUrdu: 'روزانہ کے اسباق و ڈائری', labelEnglish: 'Lessons', iconName: 'BookOpen' },
    { id: 'mms_parent_hifz', labelUrdu: 'حفظِ قرآن کیفیت', labelEnglish: 'Hifz Progress', iconName: 'BookmarkCheck' },
    { id: 'mms_parent_exams', labelUrdu: 'امتحانات و رزلٹ کارڈ', labelEnglish: 'Exams & Results', iconName: 'Award' },
    { id: 'mms_parent_fees', labelUrdu: 'فیس واؤچر و کیفیت', labelEnglish: 'Fees', iconName: 'CreditCard' },
    { id: 'mms_parent_announcements', labelUrdu: 'ادارے کے اعلانات', labelEnglish: 'Announcements', iconName: 'Bell' },
    { id: 'mms_parent_profile', labelUrdu: 'پروفائل', labelEnglish: 'Profile', iconName: 'User' },
  ],
};
